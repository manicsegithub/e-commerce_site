...
<body>
    ...
    <div class="row px-1" >
        <div class="col-md-10">
            ...
            getproducts();//limit product will be display
            //get_all_products();
            get_unique_products();
            get_unique_brand();

            // $ip = getIPAddress();  //ip address fn call from common_function.php
            // echo 'User Real IP Address - '.$ip;  

            cart();//calling the cart_details from common_function.php
